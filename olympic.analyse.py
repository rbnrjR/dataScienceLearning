...
# olympic data ---- >
countries = ['China', 'USA', 'UK', 'Russia', 'Germany',
             'Australia', 'India', 'Pakistan', 'Korea']
...
avg_medals = olympic_resultTable_df[[
    'gold', 'bronze', 'silver']].apply(numpy.mean)
...
# add function is not properly adding the matrix
total_points = numpy.add(gold_points, silver_points, bronze_points)
